...
Shader "ClipStudioLike/UI/23_カラー比較(明)"
{
    Properties
    {
        ...
        SubShader
        {
            ...
            CGPROGRAM
                ...
                fixed4 frag(v2f IN) : SV_Target
                {
                    ...
                    float srcLuminance = (0.298912 * srcColor.r + 0.586611 * srcColor.g + 0.114478 * srcColor.b);

                    color.rgb = (colorLuminance > srcLuminance) ? color.rgb : srcColor;
